...
impl<'a, T: MeshType> ValidVertexCursorMut<'a, T> {
    ...
    #[inline]
    #[must_use]
    pub fn into_immutable(self) -> ValidVertexCursor<'a, T> {
        ValidVertexCursor::load_new(self.mesh, self.id_unchecked())
    }
}
...
impl_cursor_data!(
   ...
   VertexCursorBuilder, ValidVertexCursorBasics, VertexCursorBasics, VertexCursorHalfedgeBasics
);

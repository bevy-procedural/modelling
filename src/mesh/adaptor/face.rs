...
pub struct Face2ValidFaceCursorAdapter<'a, T: 'a + MeshType, I: Iterator> {
    mesh: Option<&'a T::Mesh>,
    inner: I,
}

impl<'a, T: 'a + MeshType, I: Iterator<Item = &'a T::Face>> Face2ValidFaceCursorAdapter<'a, T, I> {
...
impl<'a, T: 'a + MeshType, I: Iterator<Item = &'a T::Face>> Iterator

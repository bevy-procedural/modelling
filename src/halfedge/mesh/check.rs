...
use crate::{
    ...
    mesh::{EdgeBasics, FaceBasics, MeshBasics, MeshChecker, VertexBasics},
};
...
impl<T: HalfEdgeMeshType> MeshChecker<T> for HalfEdgeMesh<T> {
...
impl<T: HalfEdgeMeshType> std::fmt::Debug for HalfEdgeMesh<T> {
